...
#pragma config(Motor,  port7,           arm_r1,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           chassis_l3,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           chassis_l2,    tmotorVex393_MC29, openLoop)
...
int iAuton = 0;
string rgSAuton[kMaxNumberOfPages] = {/*no autons 4 u, github reaeder*/};
...
armControl( ) {
	...
	if(vexRT[Btn6U]||vexRT[Btn6D]) {
		bBraking = false;
		iOutput = (vexRT[Btn6U]-vexRT[Btn6D])*127;
	}
	else if(bBraking) {
